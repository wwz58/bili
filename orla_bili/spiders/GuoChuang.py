...
class GuochuangSpider(Spider):
    ...
    index_head = 'https://bangumi.bilibili.com/media/web_api/search/result?season_version=-1&is_finish=-1&copyright=-1&season_status=-1&pub_date=-1&style_id=-1&order=3&st=4&sort=0&season_type=4&pagesize=20'
